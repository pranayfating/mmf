...
class LightningTrainer(BaseTrainer):
    ...
    def _load_trainer(self):
        ...
        lightning_params_dict = omegaconf.OmegaConf.to_container(
            lightning_params, resolve=True
        )
        lightning_params_dict.pop("max_steps")
        lightning_params_dict.pop("max_epochs")
